  ...
  },
  {
    ...
    answer: (
      <div className="space-y-2">
        ...
        <p className="text-[#ffbc09] text-xs mt-2 font-mono">
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-3">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 bg-surface-900 hover:bg-[#ffbc09]/10 border border-surface-600 hover:border-[#ffbc09]/50 text-[#ece7e0] hover:text-[#ffbc09] rounded-lg text-xs font-mono font-bold uppercase tracking-wider transition-all"
          >
...
function AccordionItem({ faq, isOpen, onToggle }: { faq: FAQItem; isOpen: boolean; onToggle: () => void }) {
  ...
  return (
    <div className={`border-b border-surface-700/80 transition-colors ${isOpen ? 'border-[#ffbc09]/60' : ''}`}>
      <button
        type="button"
        onClick={onToggle}
        className="w-full py-6 flex items-center justify-between text-left group"
      >
        <span className={`text-base sm:text-lg font-bold pr-6 transition-colors font-display ${isOpen ? 'text-[#ffbc09]' : 'text-[#ece7e0] group-hover:text-[#ffbc09]'}`}>
          {faq.question}
        </span>
        <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 transition-all duration-300 ${
          isOpen ? 'rotate-180 bg-[#ffbc09] text-[#080403]' : 'bg-surface-800 text-gray-400 border border-surface-700'
        }`}>
          <ChevronDown size={16} />
        </div>
      </button>
              ...
              <div className="lg:sticky lg:top-28 space-y-6">
                ...
                <div className="space-y-3 pt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 p-4 rounded-2xl bg-surface-900 border border-surface-700 hover:border-[#ffbc09]/60 transition-all group shadow-depth"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-bold font-display text-[#ece7e0] group-hover:text-[#ffbc09] transition-colors">Discord Server</p>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-bold font-display text-[#ece7e0] group-hover:text-[#ffbc09] transition-colors">Reddit Forum</p>
