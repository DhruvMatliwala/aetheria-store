...
const FAQS = [
  ...
  },
  {
    ...
    a: 'The 1 Device Plan (₹199 / $2.40) activates 1 Android phone for 30 days. The 2 Devices Plan (₹370 / $4.50) allows up to 2 Android phones simultaneously. Keys bind to device hardware for the 30-day duration.',
  },
  {
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-[85vh] sm:min-h-[90vh] flex flex-col items-center justify-center text-center px-4 pt-28 pb-16 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mb-12">
            ...
            >
              <span>View Pricing (From ₹199)</span>
              <ArrowRight size={14} />
            </button>
          </div>
