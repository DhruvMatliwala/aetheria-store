...
- **Active Subsystems Running Simultaneously (All-in-One Engine)**:
  ...
  9. **Pokemon GO Strike & Ban-Wave Radar**: Scans 7 top spoofing subreddits (`r/PGSharp`, `r/PoGoAndroidSpoofing`, `r/PokemonGoSpoofing`, `r/PoGoSpooferOpenCorner`, `r/iPogo`, `r/PokemonGo`, `r/TheSilphRoad`) every 2.5 minutes with weighted NLP scoring (+3 incident, +1 inquiry, 0 speculation) and dispatches statistical spike advisories directly to Dhruv's Telegram (`741838315`). Discord broadcast to `#ban-radar` (`1552400796610470039`) is safely paused during tuning.
